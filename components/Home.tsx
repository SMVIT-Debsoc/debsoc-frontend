...
export default function HomeClient() {
  ...
  return (
    <div className="bg-[#000000] text-zinc-100 font-sans min-h-screen overflow-hidden selection:bg-white/20 selection:text-white" ref={containerRef}>
      ...
      <div className="relative w-full h-screen flex">
        ...
        <div className="absolute top-0 right-0 w-full md:w-[50%] h-full flex flex-col justify-center items-end p-8 md:pr-12 md:pl-0 z-10">
          ...
          <div className="flex flex-col md:flex-row items-start justify-end gap-12 w-full mt-24">
            ...
            <div className="mission-box bg-white/[0.02] backdrop-blur-xl border border-white/5 p-8 rounded block w-[300px] h-fit md:mt-24 shadow-2xl">
              <h3 className="text-zinc-300 text-xs tracking-[0.2em] mb-4 uppercase">Mission</h3>
            ...
            <div className="flex flex-col w-full md:w-[450px]">
              <h3 className="text-zinc-200 text-lg tracking-[0.1em] mb-6 uppercase font-light">Events</h3>
              ...
              <div className="flex gap-4 overflow-x-auto pb-4 hide-scrollbar w-full relative">
                ...
                <div className="event-card relative min-w-[280px] h-[160px] group cursor-pointer overflow-hidden rounded-sm border border-white/10 bg-zinc-900">
                  ...
                  <img src="/event1.png" alt="Event 1" className="w-full h-full object-cover grayscale brightness-75 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-700" />
                  <div className="absolute bottom-4 left-4 z-20 pr-4">
                    <h4 className="text-sm text-white font-light uppercase tracking-wider leading-snug">The Great Debate:<br/>2024 Finals</h4>
                  </div>
                ...
                <div className="event-card relative min-w-[280px] h-[160px] group cursor-pointer overflow-hidden rounded-sm border border-white/10 bg-zinc-900">
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all z-10"></div>
                  <img src="/event2.png" alt="Event 2" className="w-full h-full object-cover grayscale brightness-75 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-700" />
                  <div className="absolute bottom-4 left-4 z-20 pr-4">
                    <h4 className="text-sm text-white font-light uppercase tracking-wider leading-snug">Speech Craft:<br/>Masterclass</h4>
                  </div>
        ...
        <div className="absolute bottom-8 right-8 md:right-12 z-20 flex gap-6 text-xs text-zinc-400 font-light tracking-wider">
          <a href="#" className="hover:text-white transition-colors underline underline-offset-4 decoration-zinc-600 hover:decoration-white">Our Team</a>
          <a href="#" className="hover:text-white transition-colors underline underline-offset-4 decoration-zinc-600 hover:decoration-white">Upcoming Events</a>
          <a href="#" className="hover:text-white transition-colors underline underline-offset-4 decoration-zinc-600 hover:decoration-white">Contact</a>
        </div>
