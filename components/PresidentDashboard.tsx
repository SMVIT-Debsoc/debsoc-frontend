    ...
    const loadDashboardData = async () => {
        ...
        try {
            ...
            setPendingTasksCount(
                tasksList.filter((t: Task) => !t.completed).length,
            );
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                ...
                                <div
                                    id="log-session-card"
                                    className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden scroll-mt-8"
                                >
                                            ...
                                            <div className="space-y-5">
                                                {allTasks.length > 0 ? (
                                                    allTasks.map((task) => (
                                                        <div
                                                            key={task.id}
                                                            className={`pl-3 border-l-2 ${task.completed ? "border-emerald-500" : isOverdue(task.deadline) ? "border-red-500" : "border-blue-500"}`}
                                                        >
                    ...
                    <div className="max-w-6xl mx-auto">
                        <header className="mb-8">
                            ...
                            <p className="text-slate-500 text-sm">
                                Review past motions, attendance, and speaker
                                performances.
                            </p>
                        </header>
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex flex-col items-center justify-center bg-blue-50 text-blue-700 w-12 h-12 rounded-lg font-bold">
                                            <span className="text-[10px] leading-tight">
                                                {fmtDate(s.sessionDate).month}
                                            </span>
                                            <span className="text-lg leading-tight">
                                                {fmtDate(s.sessionDate).day}
                                            </span>
                                        </div>
                    ...
                    <div className="max-w-6xl mx-auto space-y-8">
                        <header className="flex justify-between items-end">
                            <div>
                                ...
                                <p className="text-slate-500 text-sm">
                                    Assign and track deliverables across the
                                    society cabinet.
                                </p>
                            </div>
                            <div className="flex gap-3 text-xs bg-white border border-slate-200 rounded-lg p-1">
                                <span className="px-3 py-1.5 bg-blue-600 text-white rounded-md font-bold">
                                    All
                                </span>
                                <span className="px-3 py-1.5 text-slate-500 font-medium hover:bg-slate-100 rounded-md cursor-pointer transition-colors">
                                    Pending
                                </span>
                                <span className="px-3 py-1.5 text-slate-500 font-medium hover:bg-slate-100 rounded-md cursor-pointer transition-colors">
                                    Completed
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            <div className="lg:col-span-2 space-y-4">
                                {allTasks.map((t) => (
                                    <div
                                        key={t.id}
                                        className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex gap-4 items-start"
                                    >
                                        <div
                                            className={`mt-1 w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${t.completed ? "bg-emerald-50 text-emerald-600" : isOverdue(t.deadline) ? "bg-red-50 text-red-600" : "bg-blue-50 text-blue-600"}`}
                                        >
                                            {t.completed ? (
                                        ...
                                        <div className="flex-1">
                                            <div className="flex justify-between items-start mb-1">
                                                ...
                                                <span
                                                    className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${t.completed ? "bg-emerald-100 text-emerald-700" : isOverdue(t.deadline) ? "bg-red-100 text-red-700" : "bg-blue-100 text-blue-700"}`}
                                                >
                                                    {t.completed
                                                        ? "Done"
                                            ...
                                            <p className="text-sm text-slate-500 mb-3">
                                                {t.description ||
                                                    "Deliverable for cabinet operations."}
                                            </p>
                    ...
                    <div className="max-w-6xl mx-auto">
                        <header className="flex justify-between items-center mb-8">
                            <div>
                                ...
                                <p className="text-slate-500 text-sm">
                                    Management and oversight of all registered
                                    debaters.
                                </p>
                            </div>
