  ...
  const handleSaveSession = async (e: React.FormEvent) => {
    ...
    try {
      const sessionRes = await fetch('/api/cabinet/session/create', {
        ...
        body: JSON.stringify({ sessionDate, motiontype: motion, Chair: chairName })
      });
            ...
            <header className="flex justify-between items-center mb-8 border-b border-slate-200 pb-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <button 
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium transition-colors shadow-sm shadow-blue-200"
                >
                  <Plus size={18} />
                  New Session
                </button>
                            ...
                            <tr key={member.id} className="hover:bg-slate-50/50">
                              <td className="py-3 px-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <span className="font-medium text-slate-700 text-sm truncate max-w-[150px]">{member.name}</span>
                                </div>
                              </td>
