      ...
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col p-6 sticky top-0 h-screen">
        ...
        <nav className="flex flex-col gap-2 flex-1">
          ...
          >
            <CheckSquare size={20} />
            <span>Tasks</span>
            <span className="ml-auto bg-red-600 text-white text-xs font-bold px-2 py-0.5 rounded-full">5</span>
          </a>
          <a
            href="#"
        ...
        <div className="flex items-center gap-3 mt-auto pt-6">
          {/* Default user icon or placeholder for President */}
          <div className="w-10 h-10 rounded-full border-2 border-slate-700 bg-slate-800 flex items-center justify-center text-slate-300">
             <User size={20} />
          </div>
          <div className="flex flex-col flex-1">
            <span className="font-semibold text-sm text-white">Alex Morgan</span>
            <span className="text-xs text-slate-400">Society President</span>
          </div>
        ...
        {activeTab === 'Dashboard' ? (
          <div className="max-w-6xl mx-auto">
            ...
            <header className="flex justify-between items-center mb-8 border-b border-slate-200 pb-6">
              <div>
                <h1 className="text-2xl font-bold text-slate-900 mb-1">Executive Dashboard</h1>
                <p className="text-slate-500 text-sm">Oversee society operations, sessions, and member performance</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-slate-900">45 <span className="text-slate-400 text-sm font-medium normal-case">this term</span></div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="pl-3 border-l-2 border-red-500">
                            <div className="flex justify-between items-start mb-1">
                                <span className="bg-red-100 text-red-600 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">High Priority</span>
                                <span className="text-xs text-slate-400">Due Today</span>
                            </div>
                            <h3 className="text-sm font-semibold text-slate-900">Approve final term budget</h3>
                            <p className="text-xs text-slate-500 mt-0.5">Finance</p>
                        </div>
                        ...
                        <div className="pl-3 border-l-2 border-emerald-500">
                            ...
                            <h3 className="text-sm font-semibold text-slate-900">Review PR applications</h3>
                            <p className="text-xs text-slate-500 mt-0.5">Cabinet</p>
                        </div>
                        ...
                        <div className="pl-3 border-l-2 border-slate-200">
                            ...
                            <h3 className="text-sm font-semibold text-slate-900">Draft opening remarks for Nationals</h3>
                ...
                {/* Broadcast to Society Card (Modified from "Report to President") */}
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-8 h-8 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center shrink-0">
                      <Megaphone size={16} />
                    </div>
                    <h2 className="text-base font-bold text-slate-900">Broadcast Message</h2>
                  </div>
                  <p className="text-xs text-slate-500 mb-4">Send an official announcement to all Debsoc members immediately.</p>
                  ...
                  <button className="w-full bg-orange-600 hover:bg-orange-700 text-white flex items-center justify-center gap-2 py-2.5 rounded-lg font-medium text-sm transition-colors shadow-sm">
                    <Megaphone size={16} />
                    Publish Announcement
                  </button>
                </div>

                {/* Cabinet Feedback Card */}
