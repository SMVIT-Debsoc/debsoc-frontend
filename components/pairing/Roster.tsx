        ...
        async function loadProfile() {
            ...
            try {
                const response = await fetch(
                    `/api/progress/members/${selectedParticipantId}`,
                    {
                ...
                setProfileError(
                    caught instanceof Error
                        ? caught.message
                        : "Failed to load progress profile.",
                );
                            ...
                            <div className="flex min-w-0 flex-col items-start gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
                                <div className="flex w-full min-w-0 items-center gap-2 sm:gap-3">
                                    <ProfileAvatar
                                        ...
                                        seed={participant.id}
                                        className="h-9 w-9 shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_6px_16px_-6px_rgba(79,70,229,0.5)] sm:h-11 sm:w-11"
                                      ...
                                      <div className="flex items-center gap-3">
                                          {selectedParticipant ? (
                                              <ProfileAvatar
                                                  ...
                                                  seed={selectedParticipant.id}
                                                  className="h-12 w-12 shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_6px_16px_-6px_rgba(79,70,229,0.5)]"
                                      ...
                                      modalTab === "overview" ? (
                                          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-5">
                                              ...
                                              <SummaryStat
                                                  ...
                                                  value={selectedProfile.summary.speakerStrength.toFixed(
                                                      2,
                                                  )}
                                              />
                                              <SummaryStat
                                          ...
                                          <div className="grid gap-4 lg:grid-cols-3">
                                              <MetricTable
                                                  ...
                                                  rows={selectedProfile.motionTypeScores.map(
                                                      (entry) => ({
                                              ...
                                              <MetricTable
                                                  ...
                                                  rows={selectedProfile.roleScores.map(
                                                      (entry) => ({
                                                          label: entry.role,
                                                          score: entry.score,
                                                          observations:
                                              ...
                                              <MetricTable
                                                  ...
                                                  rows={selectedProfile.compatibilityProfiles.map(
                                                      (entry) => ({
                                                          label: entry.name,
                                                          score: entry.score,
                                                          observations:
