    ...
    <Card className="p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div><h2 className="text-sm font-semibold text-slate-950 dark:text-slate-100">Connect your OpenRouter key</h2><p className="mt-1 max-w-2xl text-xs leading-5 text-slate-500 dark:text-slate-400">The key stays in component memory and is sent only to the configured Debass backend. It is never stored in localStorage, URLs, or the database.</p></div>
        </div>
