...
import { DEBASS_KEY_PRIVACY_COPY, DEBASS_KEY_STORAGE_COPY } from "@/lib/debass/privacy";
    ...
    <Card className="p-4">
      ...
      <div className="mt-3 rounded-xl border border-border bg-muted/50 p-3">
        <label htmlFor="remember-assistant-key" className="flex cursor-pointer items-start gap-3">
          ...
          <span className="min-w-0"><span className="block text-sm font-medium text-foreground">Remember key on this device</span><span id="assistant-key-help" className="mt-0.5 block text-xs leading-5 text-muted-foreground">{DEBASS_KEY_STORAGE_COPY}</span></span>
        </label>
