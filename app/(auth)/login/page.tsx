    ...
    <div className="flex flex-col md:flex-row w-full max-w-5xl gap-6 md:gap-0 h-auto md:h-[640px] items-stretch">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-extralight tracking-tight text-white leading-none mb-6">
            THE ART OF <br />
            <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 via-white to-zinc-500 italic">ARGUMENT.</span>
          </h1>
      ...
      >
        ...
        <div className="relative z-10 flex p-1 bg-white/[0.03] border border-white/5 rounded-2xl mb-10">
          ...
          >
            {mode === 'login' && (
              <motion.div layoutId="activeTab" className="absolute inset-0 bg-white/[0.08] border border-white/10 rounded-xl shadow-inner" />
            )}
                        ...
                        <button
                          ...
                          className={`flex flex-col items-center justify-center gap-2 p-3 rounded-2xl border transition-all duration-300 ${
                            selectedRole === roleType.id 
                              ? "bg-white/[0.08] border-rose-500/40 text-white shadow-[0_0_20px_rgba(244,63,94,0.15)] scale-[1.02]" 
